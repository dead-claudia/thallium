...
t.test("core (basic) returns the current instance when given a callback", function () { t.skip() }) // eslint-disable-line max-len
t.test("core (basic) returns a prototypal clone when not given a callback", function () { t.skip() }) // eslint-disable-line max-len
