...
t.testSkip("core (basic) returns the current instance when given a callback", function () {})
t.testSkip("core (basic) returns a prototypal clone when not given a callback", function () {})
