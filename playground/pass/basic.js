...
t.test("core (basic)", function () {
    ...
    t.test("returns the current instance when given a callback", function () {})
    t.test("returns a prototypal clone when not given a callback", function () {}) // eslint-disable-line max-len
