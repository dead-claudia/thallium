...
t.test("cli common", function () {
    ...
    t.test("resolveDefault()", function () {
        ...
        t.test("gets ES6 default objects with `default` property", function () {})  // eslint-disable-line max-len
        t.test("gets ES6 default functions with `default` property", function () {})  // eslint-disable-line max-len
        t.test("gets ES6 default arrays with `default` property", function () {})  // eslint-disable-line max-len
    ...
    t.test("normalizeGlob()", function () {
        ...
        t.test("edge cases", function () {
            ...
            t.test("normalizes `..` with a cwd of `.`", function () {})
            t.test("normalizes `.` with a cwd of `..`", function () {})
            t.test("normalizes directories with a cwd of `..`", function () {})
    ...
    t.test("globParent()", function () {
        ...
        t.test("gets a base name from brace .. expansion", function () {})
        t.test("gets a base name from extglob", function () {})
        t.test("gets a base name from a complex brace glob", function () {})
    })
})
