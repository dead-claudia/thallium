...
suite 'assertions (includes)', !->
    ...
    suite 't.notIncludesDeepAll()', !->
        ...
        test 'checks objects', !->
            ...
            fail 'notIncludesDeepAll', [{foo: 1}, {bar: 2}], [{foo: 1}, {bar: 2}]
    ...
    suite 't.notIncludesLooseDeepAll()', !->
        ...
        test 'checks objects', !->
            ...
            t.notIncludesLooseDeepAll [{foo: 1}, {bar: 2}], [{foo: 1}, {bar: 1}]

            fail 'notIncludesLooseDeepAll', [{foo: 1}, {bar: 2}], [{foo: 1}, {bar: 2}]
    ...
    suite 't.notIncludesLooseDeep()', !->
        ...
        test 'checks objects', !->
            ...
            fail 'notIncludesLooseDeep', [{foo: 1}, {bar: 2}], [{foo: 1}, {bar: 1}]
            fail 'notIncludesLooseDeep', [{foo: 1}, {bar: 2}], [{foo: 1}, {bar: 2}]
