...
suite 'assertions (computation)', !->
    ...
    basic 't.throwsMatch()', !->
        ...
        fail 'throwsMatch', test, (!= sentinel)
        fail 'throwsMatch', (!->), (!= sentinel)
    ...
    basic 't.notThrowsMatch()', !->
        ...
        t.notThrowsMatch test, (!= sentinel)
        t.notThrowsMatch (!->), (!= sentinel)
    ...
    basic 't.length()', !->
        ...
        t.throws (-> t.length void, -1), TypeError
    ...
    basic 't.notLength()', !->
        ...
        t.throws (-> t.notLength void, -1), TypeError
