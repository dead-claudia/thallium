...
exports.on = function (methods) {
    return function (opts) {
        ...
        return function (report) {
            ...
            if (report.start) {
                _.running = true
            } else if (report.enter || report.pass) {
...
methods(ConsoleReporter, Reporter, {
    ...
    printResults: function () {
        ...
        .then(function () {
            return Util.peach(self.errors, function (report, i) {
                ...
                .then(function () {
                    return printFailList(self, simpleInspect(report.value))
                })
                .then(function () { return self.print() })
            })
        })
    ...
    printError: function (report) {
        var self = this
        var lines = simpleInspect(report.value).split(/\r?\n/g)
