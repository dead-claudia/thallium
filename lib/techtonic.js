...
var BaseTest = require("./test/base-test.js")
var InlineTest = require("./test/inline-test.js")
var BlockTest = require("./test/block-test.js")
var dummy = require("./test/dummy-test.js")
var skip = require("./test/skip-test.js")
var AsyncTest = require("./test/async-test.js")

var activeReporters = require("./test/common.js").activeReporters
var util = require("./util/util.js")
var isIterator = util.isIterator
var bind = util.bind
...
methods(Techtonic, {
    ...
    // Add a single reporter. Multiple calls to this are allowed, and this may
    // be passed either a single reporter or any number of possibly nested lists
    // of them.
...
methods(Techtonic, {
    ...
    timeout: function (timeout) {
        if (arguments.length) {
            ...
            return ctx.timeout || AsyncTest.DEFAULT_TIMEOUT
        }
    },
    ...
    // This should *always* be used by plugin authors if a test method modifies
    ...
    // The callback is called with a single possible error argument.
...
function makeTest(Inline, Block) {
    return /** @this */ function (name, callback) {
        ...
        if (typeof callback !== "function" && callback != null) {
            throw new TypeError(m("type.test.callback"))
        }
...
methods(Techtonic, {
    ...
    // Call to get a list of active reporters, either on this instance or on the
    // closest parent. This is the *only* method that can be called at any
    // point, as the result is a different reference.
    reporters: function () {
