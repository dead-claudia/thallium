...
var messages = {
    ...
    "type.iterate.return": "Iterator return() must return an object",
    ...
    "type.test.callback": "Expected callback to be a function or not exist",
...
module.exports = function (name) {
    ...
    return message.replace(/\{(\d+)\}/, function (_, index) {
        return args[index]
    })
}
