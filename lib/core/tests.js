...
var warnNoArgs = (function () {
    // Do it this way, because Browserify/etc. inserts things like `process` as
    // variables, not actual globals.
    var process = global.process
    var console = global.console

    var canWarn = typeof process === "object" && process != null
        ? !process.env.THALLIUM_NOWARN
        // Always warn in browsers.
        : typeof console === "object" && console != null &&
