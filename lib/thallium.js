...
var AssertionError = Errors.define([
...
function runAsync(Test, name, callback) {
    ...
    var T = isOnly(this._, name) ? Test : Fake.Dummy.Block
    var index = this._.tests.length
...
methods(Thallium, {
    ...
    run: function (callback) {
        ...
        .catch(/** @this */ function (e) {
            return Common.report(this._, r("error", e)).throw(e)
        })
        .bind().return()
        .asCallback(callback)
    },
     ...
     */
    reporters: function () {
        return Common.activeReporters(this._).slice()
    },
