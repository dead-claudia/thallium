...
var ArgumentError = require("./argument-error.js").ArgumentError
...
function serialize(argv) {
    ...
    function push(type, value) {
        args.push({type: type, value: value, boolean: boolean})
    }
...
function dispatch(args, arg, last) {
    ...
    case "value":
        ...
        if (Array.isArray(current.value)) {
            ...
            argSet(current, last.boolean || arg.value)
        }
...
exports.parseArgs = function (cwd, argv) {
