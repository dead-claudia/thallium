...
var SupportsColor = require("../reporter/console.js").SupportsColor
...
exports.run = function (opts) {
    ...
    if (state.args.color != null) {
        SupportsColor.forced = true
        SupportsColor.set(state.args.color)
    }
    ...
    .then(function (data) {
        ...
        return Resolver.resolve1(data.thallium.run, data.thallium)
    })
