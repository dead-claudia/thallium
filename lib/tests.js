...
methods(Report, {
     ...
     */
    inspect: function () {
        var resultProto = Object.create(Report.prototype)

        // Avoid a recursive call when `inspect`ing a result by making `inspect`
        // not a function. It's not an own property, so it doesn't get displayed
        // by default.
        resultProto.inspect = undefined
