...
methods(Report, {
    ...
    get hook() { return (this._ & Types.Hook) !== 0 },
...
function FailReport(path, value, duration, slow) {
...
function ErrorReport(value) {
    Report.call(this, Types.Error)
    this.value = value
}

exports.HookError = HookError
function HookError(stage, func, value) {
    this._ = stage
...
function HookReport(path, value) {
    Report.call(this, value._)
    this.path = path
...
methods(HookReport, Report, {
    ...
    get beforeAll() { return this._ === Types.BeforeAll },
    get beforeEach() { return this._ === Types.BeforeEach },
    get afterEach() { return this._ === Types.AfterEach },
    get afterAll() { return this._ === Types.AfterAll },
})
...
/**
 * Base tests (i.e. default export, result of `internal.createRoot()`).
 */
