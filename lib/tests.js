...
Common.methods(Inline, Test, {
    init: function () {
        ...
        // The unit tests use child-less inline tests a ton, as it's more
        // concise to write. But for users, it's likely a mistake.
        if (end === 0 && !process.env.THALLIUM_NOWARN) {
            warnNoArgs(this)
        }
...
/**
 * The namespaces for skipped tests
 */
