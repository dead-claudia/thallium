...
exports.deepEqual = function (actual, expected, type) {
    ...
    function primMatch(a, b) {
        switch (type) {
        case "strict": return strictIs(a, b)
        case "match": return strictIs(a, b) || symbolIs(a, b)
        case "loose": return looseIs(a, b) || symbolIs(a, b)
