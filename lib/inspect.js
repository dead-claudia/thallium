 ...
 * close copy from util-inspect, which itself is derived from Node, but there
 * are a few differences and modifications, including the fact this requires
 * ES5.
 */
...
//
// This deviates by returning a single-quoted string instead, because the rest
// of this uses that instead.
function quote(value) {
    ...
    //
    // Technically, the spec says to iterate through code points, but you can
    // safely ignore this unless you need to manipulate surrogates, which isn't
    // the case here.
...
module.exports = function inspect(obj, opts) {
    // default options
    var ctx = {
        seen: [],
